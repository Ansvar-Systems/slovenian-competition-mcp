...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fslovenian-competition-mcp.svg)](https://www.npmjs.com/package/@ansvar/slovenian-competition-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/slovenian-competition-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/slovenian-competition-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/slovenian-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add slovenian-competition-mcp --transport http https://mcp.ansvar.eu/slovenian-competition/mcp` |
...
```json
{
  "mcpServers": {
    "slovenian-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/slovenian-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/slovenian-competition-mcp
```
...
```json
{
  "mcpServers": {
    "slovenian-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/slovenian-competition-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `si_comp_search_decisions` | Full-text search across AVK (Agencija za varstvo konkurence) enforcement decisions covering abuse of dominance, carte... |
| `si_comp_get_decision` | Get a specific AVK decision by case number (e.g., |
| `si_comp_search_mergers` | Search AVK merger control decisions (nadzor koncentracij). Returns merger cases with acquiring party, target, sector,... |
| `si_comp_get_merger` | Get a specific AVK merger control decision by case number (e.g., |
| `si_comp_list_sectors` | List all sectors with AVK enforcement activity, including decision counts and merger counts per sector. |
| `si_comp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
